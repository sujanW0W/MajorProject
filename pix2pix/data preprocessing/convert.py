...
# for file in listing:
#     img = Image.open(f"C:\\Users\Shady\Desktop\pix2pix\\alley\\{img_id}.jpg").convert('RGB') 
#     img_arr = np.array(img)

#     x_lower_limit = randint(0,231)
#     y_lower_limit = randint(0,231)

#     # Turning the pixel values to black 
#     img_arr[x_lower_limit : x_lower_limit+25, y_lower_limit : y_lower_limit+25] = (0, 0, 0)
    
#     # Creating an image out of the previously modified array
#     img = Image.fromarray(img_arr)
#     img.save(f"C:\\Users\Shady\Desktop\pix2pix\maskalley\\{img_id}.jpg")  
#     img_id += 1