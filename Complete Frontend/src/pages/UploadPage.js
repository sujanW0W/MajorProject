    ...
    return (
        <div style={{ background: "black" }}>
            ...
            <div className="sub-container1">
                <div
                    className="image-back1"
                    style={{ backgroundImage: `url(${Background2})` }}
                >
                    <h3>COLORIZE! ONLINE</h3>
                    <div className="title">
                        <h1>
                            Best Picture Colorizer that Adds Color to Black and
                            White Old Pictures. No Account Needed!
                        </h1>
                    </div>
                    <div className="upload-sec">
                        <div className="uploadimage-container">
                            <div className="inner-upload-container">
                                ...
                                >
                                    {" "}
                                    <img
                                        className="inner-upload-container"
                                        src="img/1.png"
                                        alt=""
                                    ></img>
                                </button>
                            ...
                            <div>
                                <p style={{ color: "white" }}>
                                    Less than 5MB, 3000×3000, Support .jpg .jpeg
                                    .png.
                                </p>
                            </div>
                        </div>
                        ...
                        {showdiv ? (
                            <div className="show_content">
                                <img
                                    className="show_imgcontent"
                                    src={fileDataURL}
                                    alt=""
                                ></img>
                                <div className="btn-content">
                                    <button
                                        className="btn-innercontent"
            ...
            <div className="sub-container21">
                ...
                <div className="title">
                    <h1 style={{ fontSize: "1vw" }}>
                        Subscribe to our services to colorize large B&W pictures
                        upto 6000px*6000px Now you can edit photo online before
                        uploading for AI processing
                    </h1>
                </div>
